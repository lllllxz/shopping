            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <user-addresses-create-and-edit inline-template>
                        @if($address->id)
                            <form action="{{ route('user_addresses.update', ['user_address' => $address->id]) }}" class="form-horizontal" method="post" role="form">
                                {{ method_field('PUT') }}
                        @else
                        ...
                        @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="contact_tel" value="{{ old('contact_tel', $address->contact_tel) }}">
                                </div>
                            </div>
