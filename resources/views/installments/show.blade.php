                        ...
                        <div class="installment-info">
                            <div class="line">
                                ...
                                <div class="line-value">
                                    <a href="{{ route('orders.show', ['order' => $installment->order_id]) }}">查看</a>
                                </div>
                            </div>
                            <div class="line">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach($items as $item)
                                <tr>
                                    <td>{{ $item->sequence }} / {{ $installment->count }} 期</td>
                                    ...
                                    <td>
                                        @if(is_null($item->paid_at))
                                            ...
                                            @else
                                                <span class="needs-repay">代还款</span>
                                            @endif
                                        @else
                                    ...
                                    <td>￥ {{ $item->base }}</td>
                                    <td>￥ {{ $item->fee }}</td>
                                    <td>{{ is_null($item->fine) ? '—' : '￥'.$item->fine }}</td>
