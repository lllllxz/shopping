                            ...
                            <tr data-id="{{ $cartItem->productSku->id }}">
                                <td>
                                    <input type="checkbox" name="select"
                                           value="{{ $cartItem->productSku->id }}" {{ $cartItem->productSku->product->on_sale ? 'checked' : 'disabled'}}>
                                </td>
                                <td class="product_info">
                                    <div class="preview">
                                        <a href="{{ route('products.show', [$cartItem->productSku->product->id]) }}"
                                           target="_blank">
                                ...
                                <td>
                                    <span class="price">{{ $cartItem->productSku->price }}</span>
                                </td>
                                <td>
                                    <div class="number-box">
                                        <button class="on-number number-action" data-action="decrement">-</button>
                                        <input type="text" id="amount" class="form-control form-control-sm amount"
                                               @if(!$cartItem->productSku->product->on_sale) disabled
                                               @endif name="amount" value="{{ $cartItem->amount }}" data-min="1"
                                               data-step="1">
                                ...
                                <div class="col-sm-9 col-md-7">
                                    <select class="form-control" name="address">
                                        @foreach($addresses as $address)
                                            <option
                                                value="{{ $address->id }}">{{ $address->full_address }} {{ $address->contact_name }} {{ $address->contact_tel }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
        ...
        $(function () {
            $(".on-number").on('click', function () {
                ...
                if (action == 'decrement') {
                    ...
                    $(this).siblings(".amount").val(val - step)
                } else {
                    $(this).siblings(".amount").val(Number(val) + Number(step))
                }
            })
